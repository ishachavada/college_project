    ...
    <![endif]-->
			...
			<div class="ad nav navbar-inverse navbar-top-fixed">
				...
				<div class="collapse navbar-collapse" id="coo">
					<div class="row container">
						<div class="col-md-2">
							<img width="60px" id="ba" title="Doctor Patient Portal" src="img/logom.png" />
						</div>
						<div class="col-md-3">
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										...
										<table width="400px" cellpadding="2" border="0">
											<tr>
												<td style="padding:5px;">Total Doctor Registered : </td>
												<td style="padding:5px;"><span class="badge"><?php echo $doc; ?></span></td>
											</tr>
											<tr>
												<td style="padding:5px;">Verified Doctor Registered : </td>
												<td style="padding:5px;"><span class="badge"><?php echo $docv; ?></span></td>
											</tr>
											<tr>
												<td style="padding:5px;">Unverified Doctor Registered :</td>
												<td style="padding:5px;"> <span class="badge"><?php echo $docuv; ?></span></td>
											</tr>
											<tr>
												<td style="padding:5px;">Total Patient Registered : </td>
												<td style="padding:5px;"> <span class="badge"><?php echo $pat; ?></span></td>
											</tr>
											<tr>
												<td style="padding:5px;">Total Registered : </td>
												<td style="padding:5px;"> <span class="badge"><?php echo $total; ?></span></td>
											</tr>
										</table>
									</div>
								</div>
							...
							<div class="col-md-6">
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										...
										<table width="400px" cellpadding="2" border="0">
											<tr>
												<td style="padding:5px;">Total Pending Appointments : </td>
												<td style="padding:5px;"><span class="badge"><?php echo $pen; ?></span></td>
											</tr>
											<tr>
												<td style="padding:5px;">Total Completed Appointments : </td>
												<td style="padding:5px;"><span class="badge"><?php echo $com; ?></span></td>
											</tr>
											<tr>
												<td style="padding:5px;">Total Canceled Appointments : </td>
												<td style="padding:5px;"><span class="badge"><?php echo $can; ?></span></td>
											</tr>
											<tr>
												<td style="padding:5px;">Total Appointments :</td>
												<td style="padding:5px;"> <span class="badge"><?php echo $ap; ?></span></td>
											</tr>
										</table>
									</div>
								</div>
		...
		<img class='imgs2' width='50px' title='$docid' src='$dir/$files'></td></center>";
									...
									<th style="text-align:center; "><a href="verify.php?did=<?php echo $row['did']; ?>" onclick="return confirm('Are you sure want to verify?')">
											<span style="font-size:25px; color:green;" class="glyphicon glyphicon-ok-circle"></span></a></th>
								</tr>
